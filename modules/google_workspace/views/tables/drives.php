...
$where              = [
    'AND ' . db_prefix() . 'google_workspaces.type = \'drive\''
];
...
foreach ($rResult as $aRow) {
    ...
    if (staff_can('edit', 'google_workspace')) {
        $options .= '<a href="#" class="tw-mt-px" data-toggle="modal" data-target="#google_workspace_drive_modal" data-id="' . $aRow['id'] . '">
    ...
    if (staff_can('view', 'google_workspace')) {
        ...
        $options .= '<a href="https://drive.google.com/uc?export=download&id=' . $aRow['driveid'] . '" class="tw-mt-px">
