      ...
      $additionalColumns = [
        ...
        foreach ($rResult as $aRow) {
            ...
            $row[] = '<div class="d-flex align-items-center">
                <a href="' . admin_url('tasks/view/' . $aRow['id']) . '" onclick="init_task_modal(' . $aRow['id'] . '); return false;">' . $aRow['id'] . '</a>
                <div class="onoffswitch">
                    <input type="checkbox" name="is_pocked" class="onoffswitch-checkbox" id="is_pocked_'.$aRow['id'].'" '.($aRow['is_pocked'] ? 'checked' : '').'>
                    <label class="onoffswitch-label" for="is_pocked_'.$aRow['id'].'">
